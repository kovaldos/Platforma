document.addEventListener('DOMContentLoaded', () => {
    ...
    if (swiper2) {
        ...
        if (swiper2Parent) {
            let swiper2DuplicateSlides = swiper2Parent.querySelectorAll('.swiper-slide-duplicate');
    ...
    if (swiper9) {
        ...
        if (swiper9Parent) {
            let swiper9DuplicateSlides = swiper9Parent.querySelectorAll('.swiper-slide-duplicate');
    ...
    const spb = [
        { coordinates: [59.727545, 30.064097], balloonContentHeader: "<span>Санкт-Петербург.<br>Красное село, улица Восстановления, 66</span>" },
    ];
    ...
    if (navBox && historySection && header) {
        const scrollAnimation = () => {
            ...
            let historySectionTop = (historySection.offsetTop + 315) + header.offsetHeight;
